...
namespace Wolverine\ClickhouseClient\Query;

use Wolverine\ClickhouseClient\Exceptions\ResultException;
...
class Result implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param Query                                      $query
     * @param array                                      $rows
     * @param \Wolverine\ClickhouseClient\Query\QueryStatistic $statistic
     */
     ...
     * Returns statistic.
     *
     * @return \Wolverine\ClickhouseClient\Query\QueryStatistic
     */
     ...
     * @param string $name
     *
     * @throws \Wolverine\ClickhouseClient\Exceptions\ResultException
     *
     * @return mixed
     */
